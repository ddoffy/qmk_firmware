...
[_QWERTY] = LAYOUT(
  ...
  KC_UNDS,  KC_EQL, KC_MINS, KC_PLUS, KC_LOWER,  LCTL_T(KC_SPC),                      RCTL_T(KC_SPC),  KC_RAISE, KC_LCBR, KC_RCBR, KC_LBRC,  KC_RBRC,
                                                KC_LALT,   KC_LGUI,                     KC_RGUI,      KC_ATL_QUOT,
                                            KC_ADJ_PSCR,   KC_NXTWD,                    KC_PRVWD,     KC_TML
),
