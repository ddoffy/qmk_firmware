...
// Tap for Tab, hold for Hyper (Ctrl+Shift+Alt+Super) -- for KDE global shortcuts
#define KC_HYPR_TAB HYPR_T(KC_TAB)
...
[_QWERTY] = LAYOUT(
  ...
  KC_HYPR_TAB, KC_A, KC_S,   KC_D,    KC_F,     KC_G,   KC_PGDN,                    KC_VOLD, KC_H,    KC_J,          KC_K,    KC_L,    KC_SCLN,  KC_ENT,
