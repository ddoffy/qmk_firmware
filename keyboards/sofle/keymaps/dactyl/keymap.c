...
[_QWERTY] = LAYOUT(
  ...
  QK_GESC,  KC_Q,   KC_W,    KC_E,    KC_R,     KC_T,   KC_PGUP,                  S(KC_QUOT), KC_Y,    KC_U,          KC_I,    KC_O,    KC_P,     KC_BSPC,
  KC_TAB,   KC_A,   KC_S,    KC_D,    KC_F,     KC_G,   KC_PGDN,                     KC_QUOT, KC_H,    KC_J,          KC_K,    KC_L,    KC_SCLN,  KC_ENT,
