...
[_QWERTY] = LAYOUT(
  ...
  QK_GESC,  KC_Q,   KC_W,    KC_E,    KC_R,     KC_T,   KC_PGUP,                     KC_VOLU, KC_Y,    KC_U,          KC_I,    KC_O,    KC_P,     KC_BSLS,
  KC_BSPC,   KC_A,   KC_S,    KC_D,    KC_F,     KC_G,   KC_PGDN,                    KC_VOLD, KC_H,    KC_J,          KC_K,    KC_L,    KC_SCLN,  KC_QUOT,
