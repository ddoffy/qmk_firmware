...
[_QWERTY] = LAYOUT(
  KC_GRV,   KC_1,   KC_2,    KC_3,    KC_4,        KC_5,   KC_MUTE,                     KC_PSCR, KC_6,    KC_7,       KC_8,    KC_9,    KC_0,     KC_QUOT,
  KC_ESC,   KC_Q,   KC_W,    KC_E,    KC_R,        KC_T,   KC_VOLU,                     KC_PGUP, KC_Y,    KC_U,       KC_I,    KC_O,    KC_P,     KC_BSPC,
  KC_TAB,   KC_A,   KC_S,    KC_D,    KC_F,        KC_G,   KC_VOLD,                     KC_PGDN, KC_H,    KC_J,       KC_K,    KC_L,    KC_SCLN,  KC_ENT,
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,        KC_B,                                         KC_N,    KC_M,       KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
  KC_UNDS,  KC_EQL, KC_MINS, KC_PLUS, MO(_LOWER),  KC_SPC,                                       KC_SPC,  MO(_RAISE), KC_LCBR, KC_RCBR, KC_LBRC,  KC_RBRC,
                                                KC_LCTL,   KC_LALT,                     KC_RALT, KC_RCTL,
                                                KC_LGUI,   MO(_ADJUST),                 KC_DQUO, KC_RGUI
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
