...
[_QWERTY] = LAYOUT(
  ...
  KC_TAB,  LGUI_T(KC_A), LALT_T(KC_S), CTL_T(KC_D), LSFT_T(KC_F), KC_G,                           KC_H, RSFT_T(KC_J), RCTL_T(KC_K), RALT_T(KC_L), RGUI_T(KC_SCLN), KC_QUOT,
  KC_PIPE,  KC_Z,        KC_X,         KC_C,        KC_V,         KC_B, KC_MUTE,       _______, KC_N,  KC_M,       KC_COMM,    KC_DOT,     KC_SLSH, KC_UNDS,
            _______,     _______, KC_DEL,   LT(_LOWER, KC_BSPC),  LT(_NAV, KC_SPC),                 LT(_FUN, KC_SPC), LT(_RAISE, KC_ENT), LT(_ADJUST,KC_EQL), _______, _______
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_LOWER] = LAYOUT(
  ...
  KC_UNDS,  KC_EQL, KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR, _______,    _______, KC_LBRC, KC_RBRC, KC_QUOT, KC_DQUO, KC_BSLS,   KC_MINUS,
...
[_RAISE] = LAYOUT(
  _______,_______, _______, _______,_______, _______,                          _______,   _______, _______, _______, _______, _______,
  _______,_______, KC_7,  KC_8, KC_9,  KC_F9,                            KC_F6,     KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
  _______,_______, KC_4,  KC_5, KC_6,   KC_PSCR,                           KC_LEFT,   KC_DOWN, KC_UP,   KC_RGHT, KC_DEL,  KC_F12,
  _______,_______, KC_1,  KC_2, KC_3 ,  KC_CAPS,  _______,        _______,KC_CREATE, KC_PSCR, KC_INS,  _______, XXXXXXX, _______,
